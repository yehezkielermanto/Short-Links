...
<div class="mx-[4%] mt-[30px] text-justify">
    <p class="text-center text-[35px]">Privacy Policy</p>
    ...
    <div class="my-[30px]">
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
            ...
            help of the <a class="text-blue-500 underline underline-offset-1" href="https://www.privacypolicies.com/privacy-policy-generator/" target="_blank">Privacy Policy
                Generator</a>.</p>
    </div>

    <div class="border-t-4 border-dashed border-black">
        <h1 class="my-3 text-[22px]">Interpretation and Definitions</h1>
        <div class="my-3">
        ...
        <div class="my-3">
            ...
            <ul class="list-disc mx-[4%]">
                <li>
                    <p><u>Account</u> means a unique account created for You to access our Service or parts of our
                        Service.</p>
                </li>
                <li>
                    <p><u>Affiliate</u> means an entity that controls, is controlled by or is under common control
                ...
                <li>
                    <p><u>Company</u> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Shorten Links.</p>
                </li>
                <li>
                    <p><u>Cookies</u> are small files that are placed on Your computer, mobile device or any other
                        device by a website, containing the details of Your browsing history on that website among its many
                        uses.</p>
                </li>
                <li>
                    <p><u>Country</u> refers to: Indonesia</p>
                </li>
                <li>
                    <p><u>Device</u> means any device that can access the Service such as a computer, a cellphone or a
                        digital tablet.</p>
                </li>
                <li>
                    <p><u>Personal Data</u> is any information that relates to an identified or identifiable
                        individual.</p>
                </li>
                <li>
                    <p><u>Service</u> refers to the Website.</p>
                </li>
                <li>
                    <p><u>Service Provider</u> means any natural or legal person who processes the data on behalf of
                ...
                <li>
                    <p><u>Usage Data</u> refers to data collected automatically, either generated by the use of the
                        Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
                </li>
                <li>
                    <p><u>Website</u> refers to Shorten Links, accessible from <a href="https://shorts.in-pro.web.id/"
                            rel="external nofollow noopener" target="_blank">https://shorts.in-pro.web.id/</a></p>
                </li>
                <li>
                    <p><u>You</u> means the individual accessing or using the Service, or the company, or other legal
    ...
    <div class="my-[30px] border-t-4 border-dashed border-black">
        <h1 class="my-3 text-[22px]">Collecting and Using Your Personal Data</h1>
    ...
    <div class="my-[30px] border-t-4 border-dashed border-black">
        <div class="my-3">
            <h1 class="text-[22px]">Children's Privacy</h1>
        ...
        <div class="my-3">
            <h1 class="text-[22px]">Changes to this Privacy Policy</h1>
