...
<div class="mx-[4%] mt-[30px] text-justify">
    <p class="text-[30px] text-center">Terms and Conditions</p>
    <p>Last updated: June 03, 2023</p>

    <p>Please read these terms and conditions carefully before using Our Service.</p>
    <div class="my-5">
        <h1 class="text-[22px]">Interpretation and Definitions</h1>
        <div class="my-3">
            ...
            <ul class="mx-[4%] list-disc">
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Shorten Links.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Shorten Links, accessible from <a class="text-blue-600 underline underline-offset-1" href="https://shorts.in-pro.web.id/"
                            rel="external nofollow noopener" target="_blank">https://shorts.in-pro.web.id/</a></p>
                </li>
                <li>
    ...
    <div class="my-30px">
        <h1 class="text-[22px]">Acknowledgment</h1>
        <p class="my-3">These are the Terms and Conditions governing the use of this Service and the agreement that operates between You
            and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of
            the Service.</p>
        <p class="my-3">Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and
            Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.
        </p>
        <p class="my-3">By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any
            part of these Terms and Conditions then You may not access the Service.</p>
        <p class="my-3">Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">Links to Other Websites</h1>
        <p class="my-3">Our Service may contain links to third-party web sites or services that are not owned or controlled by the
            Company.</p>
        <p class="my-3">The Company has no control over, and assumes no responsibility for, the content, privacy policies, or practices
        ...
        <p class="my-3">We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or
            services that You visit.</p>
    </div>
    <div class="my-[30px]">
        <h1 class="text-[22p]">Termination</h1>
        <p class="my-3">We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
            whatsoever, including without limitation if You breach these Terms and Conditions.</p>
        <p class="my-3">Upon termination, Your right to use the Service will cease immediately.</p>
    </div>

    <div class="my-[30px]">
        <h1 class="text-[22px]">Limitation of Liability</h1>
        <p class="my-3">Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers
            ...
            Service.</p>
        <p class="my-3">To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for
        ...
        <p class="my-3">Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h1>
        <p class="my-3">The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; and with all faults and defects
            ...
            corrected.</p>
        <p class="my-3">Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation or
        ...
        <p class="my-3">Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">Governing Law</h1>
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">Disputes Resolution</h1>
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">Severability and Waiver</h1>
        <h2 class="mt-3">Severability</h2>
        <p class="my-3">If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and
        ...
        <h2 class="mt-3">Waiver</h2>
        <p class="my-3">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">Translation Interpretation</h1>
        <p>These Terms and Conditions may have been translated if We have made them available to You on our Service.
            You agree that the original English text shall prevail in the case of a dispute.</p>
    </div>

    <div class="my-[30px]">
        <h1 class="text-[22px]">Changes to These Terms and Conditions</h1>
    ...
    <div class="my-[30px]">
        <h1 class="text-[22px]">Contact Us</h1>
        <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
        <ul>
            <li>By email: <a class="text-blue-400 underline underline-offset-1" href="mailto:yehezkiel.ermanto28@gmail.com">yehezkiel.ermanto28@gmail.com</a></li>
        </ul>
    </div>
</div>
